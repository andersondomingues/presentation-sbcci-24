...
\newcommand{\rowcolordark}{blue!10}
\newcommand{\rowspecial}{green!10}
...
\title[Comp. \& Comm. Analysis of HRT Apps in Manycores]{% TITLE
Joint Computation and Communication Analysis of Hard Real-Time applications in Manycores}

\author[Domingues et al.¨]{Anderson R. P. Domingues, Lucas Damo, Sergio J. Filho, and Fernando G. Moraes \newline
...
\include{content/02-baseline-platform}
\include{content/03-a-framework}
\include{content/04-poc-and-results}
\include{content/05-conclusion}
